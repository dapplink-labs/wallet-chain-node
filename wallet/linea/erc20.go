...
func (client *lineaClient) Erc20BalanceOf(tokenAddress, account string, blockNumber *big.Int) (*big.Int, error) {
	if client == nil {
...
func (client *lineaClient) Erc20Decimals(tokenAddress string) (uint8, error) {
	var decimals uint8
	if client == nil {
...
func (client *lineaClient) Erc20RawTransfer(tokenAddress string, nonce uint64, to common.Address, value *big.Int, gasLimit uint64, gasPrice *big.Int) (*types.Transaction, error) {
	if client == nil {
		return nil, errors.New("nil client")
	}
	tokenContractWrapper, err := factory.NewTokenContractWrapper(common.HexToAddress(tokenAddress), client)
...
func (client *lineaClient) UnpackTransfer(tokenContract common.Address, data []byte) (to common.Address, amount *big.Int, err error) {
	if client == nil {
