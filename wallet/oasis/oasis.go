...
func (w *WalletAdaptor) getClient() *OasisClient {
	return w.client
}
...
func (wa *WalletAdaptor) GetBalance(req *wallet2.BalanceRequest) (*wallet2.BalanceResponse, error) {
	...
	result, err := wa.getClient().GetBalance(context.TODO(), req.Address)
	if err != nil {
...
func (wa *WalletAdaptor) GetNonce(req *wallet2.NonceRequest) (*wallet2.NonceResponse, error) {
	nonce, err := wa.getClient().GetNonce(context.TODO(), req.Address)
	if err != nil {
